...
#define NS_DECL_NSIREMOTESERVICE \
  ...
  NS_IMETHOD RegisterWindow(nsIDOMWindow *aWindow) override; \
...
#define NS_FORWARD_NSIREMOTESERVICE(_to) \
  ...
  NS_IMETHOD RegisterWindow(nsIDOMWindow *aWindow) override { return _to RegisterWindow(aWindow); } \
...
#define NS_FORWARD_SAFE_NSIREMOTESERVICE(_to) \
  ...
  NS_IMETHOD RegisterWindow(nsIDOMWindow *aWindow) override { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterWindow(aWindow); } \
