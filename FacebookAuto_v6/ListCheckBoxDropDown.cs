...
namespace FacebookAuto_v5
{
    public class ListCheckBoxDropDown : ComboBox
    {
        /// <summary>
        /// Internal class to represent the dropdown list of the ListCheckBoxDropDown
        /// </summary>
        internal class Dropdown : Form
        {
            ...
            /// <summary>
            /// A custom CheckedListBox being shown within the dropdown form representing the dropdown list of the ListCheckBoxDropDown.
            /// </summary>
            internal class CustomCheckedListBox : CheckedListBox
            {
                ...
                protected override void OnKeyDown(KeyEventArgs e)
                {
                    ...
                    {
                        // Enact selection.
                        ((ListCheckBoxDropDown.Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, true));
                        e.Handled = true;
                    ...
                    {
                        // Cancel selection.
                        ((ListCheckBoxDropDown.Dropdown)Parent).OnDeactivate(new CCBoxEventArgs(null, false));
                        e.Handled = true;
            ...
            private ListCheckBoxDropDown ccbParent;

            // Keeps track of whether checked item(s) changed, hence the value of the ListCheckBoxDropDown as a whole changed.
            ...
            public Dropdown(ListCheckBoxDropDown ccbParent)
            {
            ...
            ///       ListCheckBoxDropDown (after the dropdown has closed) to determine any actual value changes.
            /// </summary>
            ...
            public void CloseDropdown(bool enactChanges)
            {
                ...
                dropdownClosed = true;
                // Set the focus to our parent ListCheckBoxDropDown and hide the dropdown check list.
                ccbParent.Focus();
                this.Hide();
                // Notify ListCheckBoxDropDown that its dropdown is closed. (NOTE: it does not matter which parameters we pass to
        ...
        // text portion of the ListCheckBoxDropDown.
        ...
        public ListCheckBoxDropDown() : base()
        {
